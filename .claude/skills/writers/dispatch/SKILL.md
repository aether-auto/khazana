...
**`references/exemplars/baumol-cost-disease.mdx`**, in full during Internalize to calibrate
the bar.
...
- `references/exemplars/baumol-cost-disease.mdx` — the **gold-standard full-length dispatch**
