 ...
 *
 * Run this in the daily pipeline AFTER generate + verify and BEFORE prune,
...
const ledger = appendBuildDay(ledgerPath, { day, slugs, feedItemIds });

console.log(
  `[record-build-day] ${day}: ${slugs.length} Read(s), ` +
