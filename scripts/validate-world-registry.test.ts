...
function compliantRegistry(): WorldRegistry {
  const sources: WorldSourceEntry[] = [
    ...
    entry({ id: "allsides", licenseTier: "derived-only", cadenceLane: "slow", fields: [] }),
    entry({ id: "adfontes", licenseTier: "derived-only", cadenceLane: "slow", fields: [] }),
    entry({ id: "mbfc", licenseTier: "derived-only", cadenceLane: "slow", fields: [] }),
